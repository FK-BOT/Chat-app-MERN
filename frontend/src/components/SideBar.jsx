  ...
  return (
    <aside className="h-full w-full sm:w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      <div className="border-b border-base-300 w-full p-5">
        ...
        {/* Online filter toggle — always visible on mobile, hidden on sm, shown on lg */}
      ...
      <div className="overflow-y-auto w-full py-3">
        {filteredUsers.map((user) => (
          ...
          >
            ...
            {/* User info — visible on mobile and lg, hidden on sm */}
            <div className="block sm:hidden lg:block text-left min-w-0">
        ...
        {filteredUsers.length === 0 && (
          <div className="text-center text-sm text-zinc-500 mt-5">No contacts found</div>
        )}
      </div>
    </aside>
  )
